...
import ru.kusiapkulov.blockEleven.lineLegth.TotalLength;

import java.util.Arrays;

public class LineBroke implements TotalLength{
    PointBroke[] points;
...
//    }
    ...
    public String toString() {
        return "Линия проходящая через точки с координатами" + Arrays.toString(points);
    }
}
